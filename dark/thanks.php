...
<body>
  ...
  <header>
    <div class="wrap">
      <div class="flex-container">
        ...
        <span class="px14 dgray"> Store ufficiale online   <span class="pnl product-about"> &quot; <span class="product-name pnbd"> Ideal Slim </span>  — Diet-weight loss&quot; </span></span>
      </div>
    </div>
  </header>
          ...
          <div class="product-block">
            ...
            <div class="flex-container">
              ...
              <div>
                ...
                <p class="pnl px24"><span class="product-name pnbd"> Ideal Slim </span> <br><span class="pnl px14 product-description"> Diet-weight loss </span></p>
              </div>
            </div>
      ...
      <div class="merged-blocks flex-container">
        <div class="additional-products left-block">
          <div class="flex-container">
            ...
            <p class="pnl px14 lh140"><span class="px18 pnbd"> Risultato garantito al 100% </span><br> La garanzia sul risultato si applica solo in caso di conformità a tutte le raccomandazioni degli specialisti riguardo la durata e i metodi dell&#039;applicazione di  <span class="product-name"> &quot;Ideal Slim&quot; </span></p>
          </div>
        </div>
        ...
        <div class="additional-products right-block">
          <div class="additional-products flex-container">
            ...
            <p class="pnl px14 lh140"><span class="px18 pnbd"> Clinicamente testato </span><br> L&#039;efficacia e la sicurezza di &quot;Ideal Slim&quot; sono dimostrate da test clinici   <span class="product-name"> &quot;Ideal Slim&quot; </span>  Clinicamente testato <br><span class="pnbd px8 upp lgray2"> WCT TEST REPORT: WT-92772323432-HF-18 </span></p>
          </div>
        </div>
      </div>
  ...
  <div class="block about" id="about">
    <div class="wrap">
      ...
      <p class="pnl px32 no-padding"><span class="product-name pnbd"> &quot;Ideal Slim&quot; </span>  — è il prodotto di punta dell&#039;affidabile produttore </p>
...
<!-- Facebook Pixel Code -->
  src="https://www.facebook.com/tr?id=1624441114388043&ev=PageView&noscript=1"
